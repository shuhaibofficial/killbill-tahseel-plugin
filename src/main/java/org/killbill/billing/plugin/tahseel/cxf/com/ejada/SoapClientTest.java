...
public class SoapClientTest {
    ...
    private static final URL wsdlURL = BillManage_Service.WSDL_LOCATION;
    private static final BillManage_Service ss = new BillManage_Service(wsdlURL, SERVICE_NAME);
    private static final BillManage port = ss.getBillManageSOAP12();
    public SoapClientTest() {
    }
    ...
    public BillManageRsType callSoapService() {
