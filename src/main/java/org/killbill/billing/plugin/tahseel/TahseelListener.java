...
public class TahseelListener implements OSGIKillbillEventDispatcher.OSGIKillbillEventHandler {

    private static final Logger logger = LoggerFactory.getLogger(TahseelListener.class);

    private final OSGIKillbillAPI osgiKillbillAPI;

    public TahseelListener(final OSGIKillbillAPI killbillAPI) {
