...
@Singleton
@Path("/healthcheck")
public class TahseelHealthcheckServlet extends PluginHealthcheck {

    private final TahseelHealthcheck healthcheck;

    @Inject
    public TahseelHealthcheckServlet(final TahseelHealthcheck healthcheck) {
